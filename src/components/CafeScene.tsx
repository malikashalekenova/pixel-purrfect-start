...
const GUESTS: Npc[] = [
  ...
  },
  {
    ...
    choices: [
      { label: "Приму к сведению", reply: "Умные слышат шёпот раньше сирен.", rel: 7 },
      { label: "Ты видел там кого-то?", reply: "Не лицо. Манеру ждать.", rel: 5 },
      { label: "Значит, лучше налево?", reply: "Иногда длинная дорога короче, чем кажется.", rel: 3 },
      { label: "Тишина меня не пугает", reply: "Она и не должна. Поэтому с ней сложно.", rel: -5 },
    ],
  },
];
