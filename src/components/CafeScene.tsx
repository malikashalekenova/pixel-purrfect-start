...
const GUESTS: Npc[] = [
  ...
  },
  {
    ...
    choices: [
      { label: "Спасибо. Буду осторожен", reply: "Осторожность иногда быстрее лап.", rel: 7 },
      { label: "Что именно там не так?", reply: "Слишком много шагов за спиной и слишком мало окон со светом.", rel: 5 },
      { label: "Я сам разберусь", reply: "Все так говорят до первого пустого переулка.", rel: -1 },
      { label: "Пугаешь новичков?", reply: "Нет. Отсеиваю шумных.", rel: -7 },
    ],
  },
];
